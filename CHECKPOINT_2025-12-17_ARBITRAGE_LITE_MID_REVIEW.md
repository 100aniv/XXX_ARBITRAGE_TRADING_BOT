...
- **D99 진행 상황:**
  ...
  - **P9 (D99-10):** ⚠️ FAIL 감소 시도 (54 → 54 유지, 목표 미달성)
    - Top 5 클러스터 분석: D37(5), D89_0(4), D87_3(4), D78(4), D79_4(6)
    - 근본 원인 규명: 환율 정규화 불일치, 가중치 변경, Executor 이슈
    - 다음: D37 테스트 수정 + D89_0 업데이트 + D79_4 분석 (예상 -15 FAIL)
...
## 7. Dev Workflow: SSOT Core Regression (44 tests) + watchdog (2025-12-26)
...
- fast/regression: Core Regression SSOT (44 tests, 100% PASS)
