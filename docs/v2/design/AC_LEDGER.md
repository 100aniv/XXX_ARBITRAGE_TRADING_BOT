generated_at: 2026-02-18T04:04:42Z
...
| D_ALPHA-1U::AC-2-2 | pessimistic_drift_bps 증가 → latency_cost 증가, latency_ms 불변 (단위 테스트 검증) | D_ALPHA | DONE | logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | UNKNOWN | EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | Merged into D_ALPHA-1U::AC-1-2 (dup_key=EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/) |
...
| D_ALPHA-1U::AC-3-2 | PnL 분해 스케일 상식선 유지 (friction < 1.1% notional, 단위 테스트 검증) | D_ALPHA | DONE | logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | UNKNOWN | EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | Merged into D_ALPHA-1U::AC-1-2 (dup_key=EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/) |
...
| D_ALPHA-1U::AC-3-4 | 회귀 테스트 추가 및 PASS - `tests/test_d_alpha_1u_fix_2_reality_welding.py::test_ac4_orchestrator_quote_amount_regression_no_orderintent_price_attr`. | D_ALPHA | OPEN | logs/evidence/STEP0_BOOTSTRAP_D_ALPHA_1U_FIX_2_1_20260204_102405/ | UNKNOWN | EVID:logs/evidence/STEP0_BOOTSTRAP_D_ALPHA_1U_FIX_2_1_20260204_102405/ | missing kpi.json; missing pnl/friction breakdown artifact; Merged into D_ALPHA-1U::AC-1-4 (dup_key=EVID:logs/evidence/STEP0_BOOTSTRAP_D_ALPHA_1U_FIX_2_1_20260204_102405/) |
...
| D_ALPHA-1U::AC-4-2 | latency_cost = slippage_bps + pessimistic_drift_bps 기반 가격 영향 (KRW 단위) | D_ALPHA | DONE | logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | UNKNOWN | EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | Merged into D_ALPHA-1U::AC-1-2 (dup_key=EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/) |
...
| D_ALPHA-1U::AC-5-2 | latency_total = ms 합계 (시간 단위, 독립적 누적) | D_ALPHA | DONE | logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | UNKNOWN | EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/ | Merged into D_ALPHA-1U::AC-1-2 (dup_key=EVID:logs/evidence/d_alpha_1u_survey_off_20260131_233706/) |
...
| D207-5-1::AC-3 | REAL 20분 baseline 증거 확보 | D207 | OPEN | NONE | UNKNOWN | D207:TITLE:realbaseline | canonical evidence missing; Merged into D207-5::AC-6 (dup_key=D207:TITLE:realbaseline) |
...
| D205-13::AC-5 | 증명 테스트 4개 추가 및 PASS ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:pass | canonical evidence missing; Merged into D205-12::AC-8 (dup_key=OTHER:TITLE:pass) |
...
| D205-14-2::AC-4 | Gate 3단 PASS (Doctor/Fast/Regression) ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregression | canonical evidence missing; Merged into D205-14-1::AC-6 (dup_key=OTHER:TITLE:gatepassdoctorfastregression) |
...
| D205-14-3::AC-4 | Gate 3단 PASS (Doctor/Fast/Regression) ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregression | canonical evidence missing; Merged into D205-14-1::AC-6 (dup_key=OTHER:TITLE:gatepassdoctorfastregression) |
...
| D205-14-3::AC-7 | Git commit + push ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gitcommitpush | canonical evidence missing; Merged into AUTO-OTHER::AC-6-2 (dup_key=OTHER:TITLE:gitcommitpush) |
...
| D205-14-6::AC-6 | Gate 3단 PASS (Doctor/Fast/Regression) ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregression | canonical evidence missing; Merged into D205-14-1::AC-6 (dup_key=OTHER:TITLE:gatepassdoctorfastregression) |
...
| D205-15-2::AC-11 | D_ROADMAP 최종 업데이트 + Commit + Push ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:droadmapcommitpush | canonical evidence missing |
...
| D205-15-3::AC-7 | Gate 3단 PASS (Doctor/Fast/Regression) ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregression | canonical evidence missing; Merged into D205-14-1::AC-6 (dup_key=OTHER:TITLE:gatepassdoctorfastregression) |
| D205-15-3::AC-8 | D_ROADMAP 업데이트 + Commit + Push ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:droadmapcommitpush | canonical evidence missing; Merged into D205-15-2::AC-11 (dup_key=OTHER:TITLE:droadmapcommitpush) |
...
| D205-15-4::AC-9 | D_ROADMAP 업데이트 + Commit + Push ✅ | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:droadmapcommitpush | canonical evidence missing; Merged into D205-15-2::AC-11 (dup_key=OTHER:TITLE:droadmapcommitpush) |
...
| D205-15-5::AC-7 | Gate 3단 PASS (Doctor/Fast/Regression) + DocOps PASS | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregressiondocopspass | canonical evidence missing; canonical evidence missing; Merged into D205-15-4::AC-8 (dup_key=OTHER:TITLE:gatepassdoctorfastregressiondocopspass) |
| D205-15-5::AC-8 | D_ROADMAP 업데이트 + Commit + Push | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:droadmapcommitpush | canonical evidence missing; Merged into D205-15-2::AC-11 (dup_key=OTHER:TITLE:droadmapcommitpush) |
...
| D205-15-6::AC-6 | Gate 3단 PASS (Doctor/Fast/Regression) + DocOps PASS | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregressiondocopspass | canonical evidence missing; canonical evidence missing; Merged into D205-15-4::AC-8 (dup_key=OTHER:TITLE:gatepassdoctorfastregressiondocopspass) |
| D205-15-6::AC-7 | D_ROADMAP 업데이트 + Commit + Push | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:droadmapcommitpush | canonical evidence missing; Merged into D205-15-2::AC-11 (dup_key=OTHER:TITLE:droadmapcommitpush) |
...
| D205-15::AC-10 | D_ROADMAP 업데이트 + Git commit + push | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:droadmapgitcommitpush | canonical evidence missing; Merged into D205-14-6::AC-9 (dup_key=OTHER:TITLE:droadmapgitcommitpush) |
...
| D205-15::AC-8 | Gate 3단 PASS (Doctor/Fast/Regression) ✅ 2026-01-08 | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:gatepassdoctorfastregression | canonical evidence missing; Merged into D205-14-1::AC-6 (dup_key=OTHER:TITLE:gatepassdoctorfastregression) |
...
| D209-2::AC-5 | 테스트 케이스 - 각 리스크 임계치 초과 시나리오 테스트, ExitCode=1 확인 | OTHER | OPEN | NONE | UNKNOWN | OTHER:TITLE:exitcode | canonical evidence missing; Merged into D209-1::AC-5 (dup_key=OTHER:TITLE:exitcode) |
